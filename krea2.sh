...
install_node 'https://github.com/fchangjun/Baidu_Meux_ComfyTools' 'Baidu_Meux_ComfyTools'
install_node 'https://github.com/yolain/ComfyUI-Easy-Use' 'ComfyUI-Easy-Use'
install_node 'https://github.com/PGCRT/CRT-Nodes' 'CRT-Nodes'
...
download_model 'https://civitai.red/api/download/models/3111211?token='$TOKEN 'krea2_better_pussy_poses_v4.1.safetensors' "$MODELS_DIR/loras"
download_model 'https://civitai.red/api/download/models/3085473?token='$TOKEN 'KNPV4.1_pre.safetensors' "$MODELS_DIR/loras"
download_model 'https://civitai.red/api/download/models/3094133?token='$TOKEN 'krea2_bigger_muscular.safetensors' "$MODELS_DIR/loras"
