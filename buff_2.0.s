...
echo "=== 3. Загрузка базовых моделей и VAE ==="
download_file "https://madebyollin/sdxl-vae-fp16-fix/resolve/main/sdxl_vae.safetensors" "$MODELS_DIR/vae" "sdxl_vae.safetensors"
...
# Путь воссоздает структуру из ноды CheckpointLoaderSimple
mkdir -p "$MODELS_DIR/checkpoints/Illustrious/anime"
download_civitai "https://civitai.com/api/download/models/941012" "$MODELS_DIR/checkpoints/Illustrious/anime" "novaAnimeXL_ilV180.safetensors"

echo "=== 9. Загрузка LoRA (Полный список со скриншота + скрытые ноды) ==="
# Активные и неактивные LoRA из LoraLoader менеджера (image_ce218e.png)
download_civitai "https://civitai.com/api/download/models/номер_модели" "$MODELS_DIR/loras" "incase_style_v3-1_ponyxl_ilff.safetensors"
download_civitai "https://civitai.com/api/download/models/145837" "$MODELS_DIR/loras" "g0th1cPXL.safetensors"
download_civitai "https://civitai.com/api/download/models/номер_модели" "$MODELS_DIR/loras" "Expressive_H-000001.safetensors"
download_civitai "https://civitai.com/api/download/models/номер_модели" "$MODELS_DIR/loras" "Breast Size Slider - Illustrious - V2_alpha1.0_rank4_noxattn_last.safetensors"
...
download_civitai "https://civitai.com/api/download/models/номер_модели" "$MODELS_DIR/loras" "Hyper_Muscles_V4.2.safetensors"
download_civitai "https://civitai.com/api/download/models/номер_модели" "$MODELS_DIR/loras" "Spray Tan Slider_Pony.safetensors"
download_civitai "https://civitai.com/api/download/models/номер_модели" "$MODELS_DIR/loras" "Pony Realism Slider.safetensors"
download_civitai "https://civitai.com/api/download/models/номер_модели" "$MODELS_DIR/loras" "AmateurStyle_v3_PONY_REALISM.safetensors"
download_civitai "https://civitai.com/api/download/models/номер_модели" "$MODELS_DIR/loras" "amateur_photo_v2.safetensors"
download_civitai "https://civitai.com/api/download/models/номер_модели" "$MODELS_DIR/loras" "igbaddie-PN.safetensors"
