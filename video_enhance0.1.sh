...
install_node 'https://github.com/Fannovel16/ComfyUI-Frame-Interpolation' 'ComfyUI-Frame-Interpolation'
...
install_node 'https://github.com/ltdrdata/ComfyUI-Inspire-Pack' 'ComfyUI-Inspire-Pack'
