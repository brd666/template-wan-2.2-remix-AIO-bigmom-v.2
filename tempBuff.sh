...
# DA -> Vast.ai ComfyUI provisioning (ai-dock). Шаблон: BUFF
...
MODELS_upscale_models=(
    'https://huggingface.co/philz1337x/upscaler/resolve/main/4x_foolhardy_Remacri.pth'
)
